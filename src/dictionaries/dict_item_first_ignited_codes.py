"""
Dictionaries for Item First Ignited Codes
...
ITEM_FIRST_IGNITED_CODES = [
    ...
    ('13', 'Exterior trim, appurtenances'),
    ('14', 'Floor covering or rug/carpet/mat, surface'),
    ('15', 'Interior wall covering'),
    ...
    ('59', 'Rolled, wound material'),
    ('50', 'Storage supplies, other'),
    # Liquids, Piping, Filters
    ('61', 'Atomized, vaporized liquid'),
    ('62', 'Flammable liquid/gas (fuel) in or escaping from combustion engines'),
    ('63', 'Flammable liquid/gas in or escaping from final container or pipe before engine or burner'),
    ('64', 'Flammable liquid/gas in or escaping from container or pipe'),
    ('65', 'Flammable liquid/gas, uncontained'),
    ('66', 'Pipe, duct, conduit, hose'),
    ('67', 'Pipe, duct, conduit, or hose covering'),
    ('68', 'Filter'),
    ('60', 'Liquids, piping, filters, other'),
    # Organic Materials
    ('71', 'Agricultural crop'),
    ('72', 'Light vegetation (not crop)'),
    ('73', 'Heavy vegetation (not crop)'),
