...
def new_nfirs1():
    ...
    form.populate_incident_number()
    form.populate_incident_date()
    form.populate_exposure_number()
    form.populate_department_state_fdid()
    form.populate_department_state()
